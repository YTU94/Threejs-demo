var threeJs = {
	...
	init : function(building){
        ...
        function createCube(buildingXNumber,buildingYNumber){
        	...
        	for (var a = 0; a < buildingXNumber; a++) {
	        	...
	        	for (var i = 0; i < buildingYNumber; i++) {
			        ...
			        cubeM.position.set(buildingX*a + buildingX/2 - buildingX*buildingXNumber/2,buildingY*(i+1)-buildingY/2 -buildingY*buildingYNumber/2,buildingZ/2);
        ...
        if ( haveRoof == true) {
	        ...
	        cube.position.set(-buildingX*buildingXNumber/2,parseInt(buildingY*buildingYNumber)/2,0);
	...
	*/
    addCrack : function(crack){
    	...
    	var buildingXNumber = crack.buildingXNumber || "2";
    	var buildingYNumber = crack.buildingYNumber || "6";
    	...
    	console.log(x+"|"+y+"|"+z);
        cube.position.set(x - (buildingX*buildingXNumber/2) ,y - buildingY*buildingYNumber/2,z);    
...
            height: 1
          }), material);
			mesh.position.set(parseInt(x) + 1 - buildingX*buildingXNumber/2 ,parseInt(y)+1 - buildingY*buildingYNumber/2,parseInt(z)+1);
			scene.add(mesh);
		});
