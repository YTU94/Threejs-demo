...
console.log("start!");
//    $.get("./lib/building.json",function(data){
//     console.log("data:"+data);
// },"JSON");
var data = $.get("./lib/building.json",function(data){
    var result = data.house;
},"JSON");
        	...
        	for (var a = 0; a < buildingXNumber+buildingXNumber/2; a++) {
	        	...
	        	for (var i = 0; i < buildingYNumber; i++) {
			        ...
			        var material4 = new THREE.MeshBasicMaterial({ transparent:true, opacity:0.8, color: 0xaaaaaa  });
			         var materials = [material1,material1,material1,material3,material2,material2];
                ...
                if( (i+1)%3 == 0){
                    ...
                    for (var a = 0; a < buildingYNumber; a++) {
                        ...
                        if (a == 0) {
                            ...
                            var material4 = new THREE.MeshBasicMaterial({ transparent:true, opacity:0, color: 0xaaaaaa  });
                             var materials = [material1,material1,material1,material1,material2,material3];
                            var material = new THREE.MultiMaterial( materials );
                            cubeM = new THREE.Mesh( geometry, material );
    ...
    */
    addCrack : function(crack){
        ...
        if( !!animation == true){
            ...
            var tween = new TWEEN.Tween(this.cube.scale);
